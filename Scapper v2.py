...
#Get the ids
data=requests.get('https://www.sinclair-properties.com/search-results?NumberBedrooms=%3dthree&Location=%3d*UY*&PricePerPersonPerWeek=%3E0&availdate=&available=&xxorderby=%5borderbydesc%5d%3dpriceperpersonperweek&xxnum=2000&xxpage=1')
